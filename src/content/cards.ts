...
export const cards: CardDef[] = [
  ...
  { id: 'supply_antibiotics', kind: 'supply', rarity: 'rare', supplyKind: 'medicine', size: 1, shelfLifeWeeks: 72, basePrice: 260, buyable: true, icon: '💊', name: { zh: '广谱抗生素' }, desc: { zh: '药店限购一盒。' } },
  ...
  // 装备
  { id: 'equip_machete', kind: 'equipment', rarity: 'fine', slot: 'weapon', bonusDice: 2, forAttr: 'strength', basePrice: 150, buyable: true, icon: '🔪', name: { zh: '砍刀' }, desc: { zh: '五金店就有。' } },
  { id: 'equip_crossbow', kind: 'equipment', rarity: 'rare', slot: 'weapon', bonusDice: 3, basePrice: 1800, buyable: true, deliveryWeeks: 2, weeklyLimit: 1, icon: '🏹', name: { zh: '复合弩' }, desc: { zh: '安静，可回收。不靠力气，头脑和魅力的事也带得上。' } },
  ...
  { id: 'equip_vest', kind: 'equipment', rarity: 'rare', slot: 'armor', bonusDice: 2, basePrice: 2500, buyable: true, icon: '🦺', name: { zh: '防刺服' }, desc: { zh: '防咬也防刀。' } },
  // 晶核
...
export const cardsBatch2: CardDef[] = [
  ...
  { id: 'supply_water_filter', kind: 'supply', rarity: 'rare', supplyKind: 'water', size: 1, units: 24, basePrice: 600, buyable: true, deliveryWeeks: 2, weeklyLimit: 2, icon: '🧪', name: { zh: '户外净水器' }, desc: { zh: '一支滤芯能处理 24 人周的脏水。占一格，顶六箱矿泉水。' } },
  ...
  { id: 'supply_medkit', kind: 'supply', rarity: 'fine', supplyKind: 'medicine', size: 1, shelfLifeWeeks: 100, basePrice: 150, buyable: true, icon: '🧰', name: { zh: '急救箱' }, desc: { zh: '缝合、止血、退烧。' } },
  ...
  { id: 'equip_axe', kind: 'equipment', rarity: 'rare', slot: 'weapon', bonusDice: 3, forAttr: 'strength', basePrice: 900, buyable: true, icon: '🪓', name: { zh: '消防斧' }, desc: { zh: '劈门也劈头。比砍刀重，也比砍刀狠。' } },
