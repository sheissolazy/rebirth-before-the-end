...
export const prologueEvents: EventDef[] = [
  ...
  },
  {
    ...
    title: { zh: '全款买别墅' }, text: { zh: '城里带院子的独栋，围墙两米。三百万，贵在地段。防御 6、仓库 120 格、住 8 人，去哪都近、网购当周到；能建 7 个模块（围墙、铁门、菜地、水井、发电机房、车库工坊、犬舍），全建完要材料 46 分。' },
  ...
  },
  {
    ...
    title: { zh: '买郊区自建房' }, text: { zh: '离城四十公里，有地有井。一百五十万，便宜在偏远。防御只有 4（靠围栏和瞭望塔补）、仓库 200 格、住 12 人；能种能养，但进城做事每次多耗 1 精力，序章网购多等 1 周。能建 10 个模块（围栏、瞭望塔、大田、温室、畜栏、水塔、柴油发电、仓库、医务室、训练场），全建完要材料 82 分，大田和温室还要种子。' },
