...
export const storyEvents: EventDef[] = [
  // ================= 顾沉 =================
  {
    id: 'ev_guchen_02', locationId: 'home', icon: '⚡', once: true, weight: 0, storylineNpcId: 'guchen',
    title: { zh: '他真的来了' }, text: { zh: '末日第一周。有人敲门，敲法很有规律。是顾沉，带着两个兵。' },
    conditions: [A], durationWeeks: 1, slots: [HERO, GIFT('medicine', '给他们的伤员一些药')], check: { attrs: ['charm', 'mind'] },
    outcomes: {
  ...
  {
    id: 'ev_guchen_03', locationId: 'armygate', icon: '⚡', once: true, weight: 0, storylineNpcId: 'guchen',
    title: { zh: '告诉他六月的事' }, text: { zh: '六月会出现会跑的丧尸。上一世军区损失了一个连。' },
    conditions: [A, { type: 'month', from: 2, to: 5 }], durationWeeks: 1, slots: [HERO], check: { attrs: ['mind', 'charm'] },
    outcomes: {
  ...
  {
    id: 'ev_guchen_04', locationId: 'armygate', icon: '⚡', once: true, weight: 0, storylineNpcId: 'guchen',
  ...
  // ================= 沈砚 =================
  {
    id: 'ev_shenyan_01', locationId: 'pharmacy', icon: '🩺', once: true, weight: 0, storylineNpcId: 'shenyan',
  ...
  {
    id: 'ev_shenyan_02', locationId: 'hospital', icon: '🩺', once: true, weight: 0, storylineNpcId: 'shenyan',
    title: { zh: '医院最后的人' }, text: { zh: '医院已经沦陷。三楼还有灯。他一个人守着二十个病人。' },
    conditions: [A, { type: 'month', from: 1, to: 6 }], durationWeeks: 1, slots: [HERO, GIFT('energy', '给他电'), WEAPON], check: { attrs: ['strength', 'charm'] },
    outcomes: {
  ...
  {
    id: 'ev_shenyan_03', locationId: 'home', icon: '🩺', once: true, weight: 0, storylineNpcId: 'shenyan',
    title: { zh: '他倒下了' }, text: { zh: '七月。他在你门口晕倒。四十度。' },
    conditions: [A, { type: 'month', from: 6, to: 9 }], durationWeeks: 2, slots: [HERO, GIFT('medicine', '用药')], check: { attrs: ['mind'] },
    outcomes: {
  ...
  // ================= 谢临 =================
  {
    id: 'ev_xielin_01', locationId: 'supermarket', icon: '⏳', once: true, weight: 0, storylineNpcId: 'xielin',
  ...
  {
    id: 'ev_xielin_03', locationId: 'factory', icon: '⏳', once: true, weight: 0, storylineNpcId: 'xielin',
  ...
  {
    id: 'ev_jiangye_02', locationId: 'home', icon: '🔥', once: true, weight: 0, storylineNpcId: 'jiangye',
    title: { zh: '他的队伍' }, text: { zh: '末日之后，他带着六个人来敲你的门。都是退伍的。' },
    conditions: [A, { type: 'month', from: 1, to: 3 }], durationWeeks: 1, slots: [HERO, LEAD('jiangye', '江野')], check: { attrs: ['charm', 'mind'] },
    outcomes: {
