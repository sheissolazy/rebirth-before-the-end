...
export const modules: ModuleDef[] = [
  ...
  { id: 'apt_rain', baseType: 'apartment', name: { zh: '接雨水' }, desc: { zh: '阳台上摆满桶，屋顶接一根管。每周 4 份水（够 4 个人喝），下雨看天。' }, icon: '🪣', cost: { materialPoints: 2, labor: 1, weeks: 1 }, provides: [{ type: 'produce', supplyKind: 'water', cardId: 'supply_well_water', perWeek: 2 }] },
  ...
  { id: 'villa_well', baseType: 'villa', name: { zh: '水井' }, desc: { zh: '打井队最后一单。每周 8 份水。' }, icon: '🕳️', cost: { materialPoints: 12, labor: 3, weeks: 2 }, provides: [{ type: 'produce', supplyKind: 'water', cardId: 'supply_well_water', perWeek: 4 }] },
  ...
  { id: 'farm_watertower', baseType: 'farmhouse', name: { zh: '水塔' }, desc: { zh: '存雨水和井水。每周 8 份水。' }, icon: '🚰', cost: { materialPoints: 10, labor: 3, weeks: 2 }, provides: [{ type: 'produce', supplyKind: 'water', cardId: 'supply_well_water', perWeek: 4 }] },
  ...
  { id: 'bunker_water', baseType: 'bunker', name: { zh: '水循环' }, desc: { zh: '闭环。每周 16 份水。' }, icon: '💧', cost: { materialPoints: 16, labor: 4, weeks: 3 }, provides: [{ type: 'produce', supplyKind: 'water', cardId: 'supply_well_water', perWeek: 8 }] },
