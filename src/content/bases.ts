...
export const modules: ModuleDef[] = [
  ...
  { id: 'apt_balcony', baseType: 'apartment', name: { zh: '阳台菜箱' }, desc: { zh: '种点葱和青菜。' }, icon: '🥬', cost: { materialPoints: 2, labor: 1, weeks: 1 }, provides: [{ type: 'produce', supplyKind: 'food', cardId: 'supply_veg', perWeek: 1 }] },
  ...
  { id: 'villa_garden', baseType: 'villa', name: { zh: '院子菜地' }, desc: { zh: '够两个人吃。' }, icon: '🥕', cost: { materialPoints: 3, labor: 2, weeks: 2 }, provides: [{ type: 'produce', supplyKind: 'food', cardId: 'supply_veg', perWeek: 2 }] },
  ...
  { id: 'farm_field', baseType: 'farmhouse', name: { zh: '大田' }, desc: { zh: '土豆和玉米。' }, icon: '🌽', cost: { materialPoints: 4, labor: 4, weeks: 3 }, provides: [{ type: 'produce', supplyKind: 'food', cardId: 'supply_veg', perWeek: 4 }] },
  { id: 'farm_greenhouse', baseType: 'farmhouse', name: { zh: '温室' }, desc: { zh: '冬天也能种。' }, icon: '🏡', cost: { materialPoints: 12, labor: 3, weeks: 3 }, provides: [{ type: 'produce', supplyKind: 'food', cardId: 'supply_veg', perWeek: 2 }, { type: 'counters', crisisKind: 'climate', points: 2 }] },
  ...
  { id: 'bunker_grow', baseType: 'bunker', name: { zh: '种植舱' }, desc: { zh: '灯光种植。' }, icon: '🌱', cost: { materialPoints: 14, labor: 3, weeks: 3 }, provides: [{ type: 'produce', supplyKind: 'food', cardId: 'supply_veg', perWeek: 4 }] },
